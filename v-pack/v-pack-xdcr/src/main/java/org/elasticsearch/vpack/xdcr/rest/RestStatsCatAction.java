...
import org.elasticsearch.vpack.xdcr.action.stats.Stats;
...
public class RestStatsCatAction extends AbstractCatAction {
    ...
    protected Table getTableWithHeader(RestRequest request) {
        ...
        table.addCell("localSeqNo", "alias:ls;desc:local maxSeqNo");
        table.addCell("remoteSeqNo", "alias:rs;desc:remote maxSeqNo");
        table.endHeaders();
        return table;
    }
    ...
    private Table buildTable(RestRequest request, StatsAction.Response response) {
        ...
        for (Stats stats : response.stats()) {
            ...
            table.addCell(stats.localSeqno);
            table.addCell(stats.remoteSeqno);
            table.endRow();
        }
