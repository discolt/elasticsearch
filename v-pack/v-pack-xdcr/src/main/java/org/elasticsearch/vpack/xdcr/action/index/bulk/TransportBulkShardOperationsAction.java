...
import org.elasticsearch.vpack.xdcr.engine.AlreadyProcessedFollowingEngineException;
    ...
    public static OnceWritePrimaryResult shardOperationOnPrimary(
        ...
        for (Translog.Operation sourceOp : sourceOperations) {
            if (primary.getLocalCheckpoint() + 1 != sourceOp.seqNo()) {
                throw new IllegalStateException("invalid seqno , expect[" + (primary.getLocalCheckpoint() + 1) + "] received[" + sourceOp.seqNo() + "]");
            }
