...
public class RestPutRepositoryAction extends BaseRestHandler {
    ...
    public RestChannelConsumer prepareRequest(final RestRequest request, final NodeClient client) throws IOException {
        PutRepositoryRequest putRepositoryRequest = new PutRepositoryRequest(request.param("repository"));
        ...
        return channel -> client.execute(PutRepositoryAction.INSTANCE, putRepositoryRequest, new RestToXContentListener(channel));
    }
}
