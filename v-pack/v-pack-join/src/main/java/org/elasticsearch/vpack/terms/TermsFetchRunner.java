package org.elasticsearch.vpack.terms;
...
import org.elasticsearch.vpack.terms.collector.TermsCollector;

import java.util.concurrent.Callable;
import java.util.function.Consumer;

public class TermsFetchRunner implements Callable<TermsFetchResult> {

    private static Logger logger = LogManager.getLogger(TermsFetchRunner.class);
    ...
    public TermsFetchRunner(SearchContext searchContext, IndexSearcher searcher, TermsCollector termsCollector,
