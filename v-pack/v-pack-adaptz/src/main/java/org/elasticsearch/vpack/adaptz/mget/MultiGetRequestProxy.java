...
public class MultiGetRequestProxy extends ActionRequest
        implements Iterable<MultiGetRequestProxy.Item>, CompositeIndicesRequest, RealtimeRequest, ToXContentObject {
    ...
    public MultiGetRequestProxy add(Item item) {
        items.add(item);
        return this;
    }

    public MultiGetRequestProxy add(String index, @Nullable String type, String id) {
     ...
     */
    public MultiGetRequestProxy preference(String preference) {
    ...
    @Override
    public MultiGetRequestProxy realtime(boolean realtime) {
    ...
    public MultiGetRequestProxy refresh(boolean refresh) {
        this.refresh = refresh;
        return this;
    }

    public MultiGetRequestProxy add(String appName, @Nullable String defaultIndex, @Nullable String defaultType, @Nullable String[] defaultFields,
        ...
        while ((token = parser.nextToken()) != Token.END_OBJECT) {
            if (token == Token.FIELD_NAME) {
                ...
                if ("docs".equals(currentFieldName)) {
                    parseDocuments(parser, this.items, appName, defaultIndex, defaultType, defaultFields, defaultFetchSource, defaultRouting, allowExplicitIndex);
                } else if ("ids".equals(currentFieldName)) {
                    parseIds(parser, this.items, appName, defaultIndex, defaultType, defaultFields, defaultFetchSource, defaultRouting);
                } else {
                    final String message = String.format(
                            Locale.ROOT,
    ...
    private static void parseDocuments(XContentParser parser, List<Item> items, String appName, @Nullable String defaultIndex, @Nullable String defaultType, @Nullable String[] defaultFields, @Nullable FetchSourceContext defaultFetchSource, @Nullable String defaultRouting, boolean allowExplicitIndex) throws IOException {
        String currentFieldName = null;
        Token token;
    ...
    public static void parseIds(XContentParser parser, List<Item> items, String appName, @Nullable String defaultIndex, @Nullable String defaultType, @Nullable String[] defaultFields, @Nullable FetchSourceContext defaultFetchSource, @Nullable String defaultRouting) throws IOException {
        Token token;
        while ((token = parser.nextToken()) != Token.END_ARRAY) {
            if (!token.isValue()) {
