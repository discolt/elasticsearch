...
public class BulkRequestProxy extends ActionRequest implements CompositeIndicesRequest, WriteRequest<BulkRequestProxy> {
    private static final DeprecationLogger DEPRECATION_LOGGER =
        new DeprecationLogger(Loggers.getLogger(BulkRequestProxy.class));
     ...
     */
    public BulkRequestProxy add(DocWriteRequest... requests) {
    ...
    public BulkRequestProxy add(DocWriteRequest request) {
     ...
     */
    public BulkRequestProxy add(DocWriteRequest request, @Nullable Object payload) {
     ...
     * Adds a list of requests to be executed. Either index or delete requests.
     */
    public BulkRequestProxy add(Iterable<DocWriteRequest> requests) {
        for (DocWriteRequest request : requests) {
            add(request);
        }
        return this;
     ...
     */
    public BulkRequestProxy add(IndexRequest request) {
        return internalAdd(request, null);
    }

    public BulkRequestProxy add(IndexRequest request, @Nullable Object payload) {
        return internalAdd(request, payload);
    }

    BulkRequestProxy internalAdd(IndexRequest request, @Nullable Object payload) {
     ...
     */
    public BulkRequestProxy add(UpdateRequest request) {
        return internalAdd(request, null);
    }

    public BulkRequestProxy add(UpdateRequest request, @Nullable Object payload) {
        return internalAdd(request, payload);
    }

    BulkRequestProxy internalAdd(UpdateRequest request, @Nullable Object payload) {
        Objects.requireNonNull(request, "'request' must not be null");
        requests.add(request);
        addPayload(payload);
        if (request.doc() != null) {
     ...
     */
    public BulkRequestProxy add(DeleteRequest request) {
        return add(request, null);
    }

    public BulkRequestProxy add(DeleteRequest request, @Nullable Object payload) {
        Objects.requireNonNull(request, "'request' must not be null");
        requests.add(request);
        addPayload(payload);
    ...
    public BulkRequestProxy add(BytesReference data, String appName, @Nullable String defaultIndex, @Nullable String defaultType, @Nullable String
                    ...
                    while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                        if (token == XContentParser.Token.FIELD_NAME) {
                            ...
                            if (INDEX.match(currentFieldName, parser.getDeprecationHandler())){
                                ...
                                index = Adapts.toConcreteIndex(appName, parser.text());
                                ...
                                pipeline = Adapts.toConcreteIndex(appName, parser.text());
     ...
     */
    public BulkRequestProxy waitForActiveShards(ActiveShardCount waitForActiveShards) {
     ...
     */
    public BulkRequestProxy waitForActiveShards(final int waitForActiveShards) {
    ...
    @Override
    public BulkRequestProxy setRefreshPolicy(RefreshPolicy refreshPolicy) {
     ...
     */
    public final BulkRequestProxy timeout(TimeValue timeout) {
     ...
     * A timeout to wait if the index operation can't be performed immediately. Defaults to {@code 1m}.
     */
    public final BulkRequestProxy timeout(String timeout) {
