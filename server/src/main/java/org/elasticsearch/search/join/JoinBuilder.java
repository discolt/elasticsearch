...
public class JoinBuilder implements Writeable, ToXContentObject, NamedWriteable {
    ...
    public JoinBuilder(String sourceField, String[] indices, String field, QueryBuilder queryBuilder) {
    ...
    public JoinBuilder(StreamInput in) throws IOException {
    ...
    public static List<JoinBuilder> fromXContent(XContentParser parser) throws IOException {
        List<JoinBuilder> joinFields = new ArrayList<>(2);
    ...
    private static void parseCompoundSortField(XContentParser parser, List<JoinBuilder> joinFields)
            throws IOException {
        joinFields.add(buildSingle(parser));
    }

    public static JoinBuilder buildSingle(XContentParser parser) throws IOException {
        ...
        JoinBuilder queryBuilder = new JoinBuilder(sourceField, indices, targetField, query);
        return queryBuilder;
    }

    @Override
    public boolean equals(Object other) {
        if (!(other instanceof JoinBuilder)) {
            return false;
        }

        JoinBuilder o = (JoinBuilder) other;
